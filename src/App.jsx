  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://ekart-newsletter.duckdns.org/message/send",
        {
          method: "POST",
          headers: {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 mb-4 sm:mb-0 sm:mr-4 border-gray-800 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900"
                  required
                />
              </div>
              <div>
...
const Newsletter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://ekart-newsletter.duckdns.org/message/getMailNews",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
